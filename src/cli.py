...
@click.option(
    ...
    help="Path to config TOML (default: ~/.config/confluence-cli/config.toml)",
)
@click.option(
    "--profile",
    default="default",
...
# expose both names for consistency
cli.add_command(convert_only, name="convert")       # confluence convert ...
cli.add_command(convert_only, name="convert-only")  # confluence convert-only ...
